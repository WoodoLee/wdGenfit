...
int main()
{
  ...
  TString fileName = "/home/wdlee/ssd1/work/data/genfit2g2Data/g2wd.root";
  ...
  tree -> SetBranchAddress("hitPosX"   , &hitPosX       ); // Br 0
  tree -> SetBranchAddress("hitPosY"   ,  &hitPosY   ); // Br 1
  tree -> SetBranchAddress("hitPosZ"   , &hitPosZ        ); // Br 2
  tree -> SetBranchAddress("hitPX"     , &hitPX          ); // Br 3
  tree -> SetBranchAddress("hitPY"     , &hitPY          ); // Br 3
  tree -> SetBranchAddress("hitPZ"     , &hitPZ          ); // Br 3
  tree -> SetBranchAddress("hitPMag"   , &hitPMag          ); // Br 3

  int nEntries = tree -> GetEntries();

  std::cout << "\033[1;32m [Notice] " << nEntries << " number of Entries. \033[0m" << std::endl;
  ...
  for ( int i = 0; i < nEntries; i++ )
  {
    tree -> GetEntry(i);
      ...
      TVector3 pos( hitPosX.at(0)/ 10.  , hitPosY / 10.    , hitPosZ / 10.  );
      TVector3 mom( hitPX / 1000. , hitPY / 1000.  , hitPZ / 1000. );
      TVector3 momTemp( hitPX / 1000. , hitPY / 1000.  , hitPZ / 1000. );
      ...
      for (int l =0; l< nHits; l++)
      {
        ...
        TVector3 cPos(xhit[l] / 10. , yhit[l] / 10.  , zhit[l] / 10. );
        ...
        genfit::PlanarMeasurement * measurement = new genfit::PlanarMeasurement(hitCoords, hitCov, 0., l ,nullptr );
